...
public class FanOutTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("expected result: " + expected_times * (testStr.length() + testStr.lastIndexOf('s')));
	}
	...
	static void test(TestMethod method, int times, boolean output) {
		...
		if (output) System.out.println((endTime - startTime) + " ns for " + times + " iterations, method " + method.name);
	}
