...
public class BasicOperatorConfig extends ArrayOptionListConfig<IBasicOperator> implements IScriptBase {
	public BasicOperatorConfig(@NotNull ILPCConfigReadable parent) {
		super(parent, nameKey);
		for(IBasicOperator operator : basicOperators)
