...
public class FromBlockVariable extends UniqueStringConfig implements IScriptBlockSupplier {
	...
	@Override public @NotNull Function<CompiledVariableList, Block> compile(VariableMap variableMap) throws CompileFailedException {
		int index = variableMap.get(getStringValue(), BlockPosVariable.testPack);
		return list->list.getVariable(index);
	}
	@Override public @NotNull String getFullTranslationKey() {return fullKey;}
	public static final String nameKey = "fromBlockVariable";
