...
public class LightLevel extends WrappedThirdListConfig implements IScriptIntSupplier {
	private final BlockPosSupplierChooser pos = addConfig(new BlockPosSupplierChooser(parent, "pos", this::onValueChanged));
	public LightLevel(ILPCConfigReadable parent) {super(parent, nameKey, null);}
	...
	compileToInt(VariableMap variableMap) throws CompileFailedException {
		...
		return list->{
			...
			if(world != null){
				...
				return world.getLightLevel(buf);
			}
			else return 0;
		};
	}
	@Override public @NotNull String getFullTranslationKey() {return fullKey;}
	public static final String nameKey = "lightLevel";
