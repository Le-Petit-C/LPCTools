...
public class AnyTrue extends MutableConfig<IScriptBooleanSupplier> implements IScriptBooleanSupplier{
	public AnyTrue(@NotNull ILPCConfigReadable parent) {
	...
	public static final String nameKey = "anyTrue";
