...
public class EveryTrue extends MutableConfig<IScriptBooleanSupplier> implements IScriptBooleanSupplier{
	public EveryTrue(@NotNull ILPCConfigReadable parent) {
	...
	public static final String nameKey = "everyTrue";
