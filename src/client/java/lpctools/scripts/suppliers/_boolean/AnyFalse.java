...
public class AnyFalse extends MutableConfig<IScriptBooleanSupplier> implements IScriptBooleanSupplier{
	public AnyFalse(@NotNull ILPCConfigReadable parent) {
	...
	compileToBoolean(VariableMap variableMap) throws CompileFailedException {
		...
		return list->{
			for(ToBooleanFunction<CompiledVariableList> func : subCompiled)
				if(!func.applyAsBoolean(list)) return true;
			return false;
		};
	}
	
	@Override public @NotNull String getFullTranslationKey() {return fullKey;}
	public static final String nameKey = "anyFalse";
