...
public class Vector3dDistanceSquared extends WrappedThirdListConfig implements IScriptDoubleSupplier {
	...
	public Vector3dDistanceSquared(ILPCConfigReadable parent) {super(parent, nameKey, null);}
	...
	compileToDouble(VariableMap variableMap) throws CompileFailedException {
		...
		return list->{
			...
			return buf1.distanceSquared(buf2);
		};
	}
	@Override public @NotNull String getFullTranslationKey() {return fullKey;}
	public static final String nameKey = "vector3dDistanceSquared";
