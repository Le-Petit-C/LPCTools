...
public class Vector3dDotProduct extends WrappedThirdListConfig implements IScriptDoubleSupplier {
	...
	public Vector3dDotProduct(ILPCConfigReadable parent) {super(parent, nameKey, null);}
