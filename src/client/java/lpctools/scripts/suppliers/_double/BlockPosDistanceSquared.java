...
public class BlockPosDistanceSquared extends WrappedThirdListConfig implements IScriptDoubleSupplier {
	...
	public BlockPosDistanceSquared(ILPCConfigReadable parent) {super(parent, nameKey, null);}
	...
	compileToDouble(VariableMap variableMap) throws CompileFailedException {
		...
		return list->{
			...
			return buf1.getSquaredDistance(buf2);
		};
	}
	@Override public @NotNull String getFullTranslationKey() {return fullKey;}
	public static final String nameKey = "blockPosDistanceSquared";
