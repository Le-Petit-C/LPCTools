...
public class Registry {
    ...
    public static boolean registerClientWorldChangeCallback(AfterClientWorldChange callback){
        return clientWorldChangeCallbacks.add(callback);
    }
    public static boolean unregisterClientWorldChangeCallback(AfterClientWorldChange callback){
