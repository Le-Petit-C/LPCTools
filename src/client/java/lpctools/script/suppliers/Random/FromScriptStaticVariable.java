...
public class FromScriptStaticVariable<T> extends AbstractScript implements IRandomSupplier<T> {
	private @NotNull String variableName = "var";
	protected @Nullable WidthAutoAdjustTextField textField;
	public final Class<T> targetClass;
	
	public FromScriptStaticVariable(IScriptWithSubScript parent, Class<T> targetClass) {
		super(parent);
	...
	@Override public void setValueFromJsonElement(@Nullable JsonElement element) {
		...
		if (!(element instanceof JsonPrimitive primitive)) {
			warnFailedLoadingConfig("FromScriptStaticVariable", element);
			return;
		}
