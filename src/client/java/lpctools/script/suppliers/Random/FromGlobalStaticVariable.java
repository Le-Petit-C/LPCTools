...
public class FromGlobalStaticVariable<T> extends AbstractScript implements IRandomSupplier<T> {
	private @NotNull String variableName = "var";
	protected @Nullable WidthAutoAdjustTextField textField;
	public final Class<T> targetClass;
	
	public FromGlobalStaticVariable(IScriptWithSubScript parent, Class<T> targetClass) {
		super(parent);
	...
	compileRandom(CompileEnvironment environment) {
		...
		return runtimeVariableMap->variableRef.getValue();
	}
	...
	@Override public void setValueFromJsonElement(@Nullable JsonElement element) {
		...
		if (!(element instanceof JsonPrimitive primitive)) {
			warnFailedLoadingConfig("FromGlobalStaticVariable", element);
			return;
		}
