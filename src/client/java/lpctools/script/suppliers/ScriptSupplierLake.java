...
import lpctools.script.suppliers.Item.*;
import lpctools.script.suppliers.ItemStack.*;
...
public class ScriptSupplierLake {
	...
	static {
		...
		registerPrecise("setScriptStaticVariable", ControlFlowIssue.class, SetScriptStaticVariable.class, SetScriptStaticVariable::new);
		registerPrecise("setGlobalStaticVariable", ControlFlowIssue.class, SetGlobalStaticVariable.class, SetGlobalStaticVariable::new);
