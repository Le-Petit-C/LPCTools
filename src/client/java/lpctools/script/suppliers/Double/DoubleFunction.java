...
public class DoubleFunction extends AbstractSignResultSupplier<Signs.DoubleFunction> implements IDoubleSupplier {
	...
	public DoubleFunction(IScriptWithSubScript parent) {super(parent, Signs.NEGATIVE, Signs.doubleFunctionInfo, 0);}
