...
public class DoubleFromVec3ds extends AbstractSignResultSupplier<Signs.DoubleFromVec3dsSign> implements IDoubleSupplier {
	...
	public DoubleFromVec3ds(IScriptWithSubScript parent) {super(parent, Signs.DOT, Signs.doubleFromVec3dsSignInfo, 1);}
