...
public class DoWhileLoop extends AbstractScriptWithSubScript implements IControlFlowIssueSupplier {
	public final RunMultiple loopBody = new RunMultiple(this, Component.translatable("lpctools.script.suppliers.controlFlowIssue.doWhileLoop.loopBody.name"));
	public final And condition = new And(this, Component.translatable("lpctools.script.suppliers.controlFlowIssue.doWhileLoop.condition.name"));
